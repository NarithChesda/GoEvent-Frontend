<template>
  <div class="min-h-screen">
          ...
          <div class="lg:col-span-7 space-y-6 sm:space-y-8 animate-slide-in-left">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-4 xl:gap-6 animate-fade-in animation-delay-1200">
              ...
              >
                ...
                <ArrowRight class="inline w-4 h-4 sm:w-5 sm:h-5 ml-1 sm:ml-2 group-hover:translate-x-1 transition-transform duration-300" />
              </RouterLink>
              <button
                @click="scrollToDemo"
              ...
              >
                <Play class="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 group-hover:scale-110 transition-transform duration-300" />
                Watch Demo
              </button>
            </div>

            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 lg:gap-8 text-xs sm:text-sm animate-fade-in animation-delay-1400">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Powerful features designed to make event planning effortless, engaging, and memorable for both organizers and attendees.
          </p>
        </div>
          ...
          >
            ...
            <div class="relative">
              ...
              <div class="relative mb-6">
                <div class="w-16 h-16 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110" :class="feature.bgColor">
                  <component :is="feature.icon" class="w-8 h-8 transition-all duration-300" :class="feature.iconColor" />
                </div>
                <!-- Floating accent -->
    ...
    <section
      ...
      class="py-16 relative overflow-hidden scroll-animate"
    ...
    >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center mb-16">
          ...
          <p class="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            From intimate gatherings to large-scale conferences, see how GoEvent transforms event planning
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6 mb-16">
          <div v-for="(testimonial, index) in testimonials" :key="testimonial.name"
            ...
            <!-- Quote icon -->
            <div class="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm sm:text-lg font-bold">
              "
            </div>

            <!-- Rating stars -->
            <div class="flex text-yellow-400 mb-4 sm:mb-6">
              <Star v-for="i in 5" :key="i" class="h-4 w-4 sm:h-5 sm:w-5 fill-current" />
            </div>

            <!-- Testimonial content -->
            <blockquote class="text-slate-700 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8 font-medium">
              "{{ testimonial.content }}"
            </blockquote>

            <!-- Author info -->
            <div class="flex items-center">
              <div class="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform duration-300">
                <span class="text-blue-600 font-bold text-sm sm:text-base lg:text-lg">{{ testimonial.name.charAt(0) }}</span>
              </div>
              <div>
                <h4 class="font-bold text-slate-900 text-sm sm:text-base lg:text-lg">{{ testimonial.name }}</h4>
                <p class="text-blue-600 font-medium text-xs sm:text-sm lg:text-base">{{ testimonial.role }}</p>
              </div>
            </div>

            <!-- Hover effect background -->
            <div class="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-purple-50/50 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
          </div>
        </div>

        <!-- Trust indicators -->
        <div class="text-center">
          <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 lg:space-x-8 bg-white/60 backdrop-blur-sm rounded-2xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border border-white/20">
            <div class="flex items-center space-x-2">
              <div class="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
              <span class="text-slate-700 font-medium text-sm sm:text-base">99.9% Uptime</span>
            </div>
            <div class="hidden sm:block w-px h-6 bg-slate-300"></div>
            <div class="flex items-center space-x-2">
              <Shield class="h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
              <span class="text-slate-700 font-medium text-sm sm:text-base">Enterprise Security</span>
            </div>
            <div class="hidden sm:block w-px h-6 bg-slate-300"></div>
            <div class="flex items-center space-x-2">
              <Award class="h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
              <span class="text-slate-700 font-medium text-sm sm:text-base">Award Winning</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section
      id="faq"
      ref="faqSection"
      class="py-16 scroll-animate faq-bg"
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            Everything you need to know about GoEvent and how it can transform your event planning experience.
          </p>
        </div>
        ...
        <div class="space-y-6">
          <div
            ...
            :key="index"
            class="group bg-white/90 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm hover:shadow-lg hover:border-blue-200/50 transition-all duration-300 overflow-hidden"
          >
            <button
              @click="toggleFaq(index)"
              class="w-full px-8 py-6 text-left flex items-start justify-between font-medium text-slate-900 hover:bg-gradient-to-r hover:from-blue-50/30 hover:to-purple-50/30 transition-all duration-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 group"
            >
              <div class="flex-1 pr-6">
                <h3 class="text-xl font-bold text-slate-900 leading-tight tracking-tight group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                  {{ faq.question }}
                </h3>
              </div>
              <div class="flex-shrink-0 ml-4">
                <div class="w-10 h-10 rounded-full bg-slate-100 group-hover:bg-gradient-to-br group-hover:from-blue-100 group-hover:to-purple-100 flex items-center justify-center transition-all duration-300">
                  <ChevronDown
                    class="w-5 h-5 text-slate-500 group-hover:text-blue-600 transition-all duration-300"
              ...
              <div v-show="openFaq === index" class="overflow-hidden">
                <div class="px-8 pb-8 pt-2">
                  ...
                  <div class="prose prose-slate max-w-none">
                    <p class="text-lg text-slate-700 leading-relaxed font-medium">{{ faq.answer }}</p>
                  </div>
                </div>
              </div>
            </Transition>
        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div class="text-left">
            ...
            <p class="text-lg text-slate-300 mb-6 leading-relaxed">
              Join thousands of event organizers who trust GoEvent to deliver exceptional experiences. Start your free trial today and see the difference.
            </p>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <RouterLink
                to="/signup"
                class="group bg-white hover:bg-blue-50 text-blue-600 hover:text-blue-700 font-semibold px-8 py-4 rounded-lg text-base transition-all duration-200 hover:scale-[1.02] shadow-lg shadow-black/10 flex items-center justify-center"
              >
                Start Your Free Trial
                <ArrowRight class="w-4 h-4 sm:w-5 sm:h-5 ml-1 sm:ml-2 group-hover:translate-x-1 transition-transform duration-300" />
              </RouterLink>
              <RouterLink
                to="/contact"
                class="bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white hover:bg-white/20 hover:border-white/50 font-semibold px-8 py-4 rounded-lg text-base transition-all duration-200 hover:scale-[1.02] flex items-center justify-center"
              >
                Talk to Sales
              </RouterLink>
            </div>
          ...
          <div class="relative lg:pl-8">
            <div class="relative">
              ...
              <div class="bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-6 xl:p-8 shadow-2xl border border-white/50 transform hover:scale-105 transition-all duration-500">
                ...
                <div class="space-y-4">
                  <div class="flex justify-between items-center">
                    <span class="text-slate-600">Active Events</span>
                    <span class="font-bold text-slate-900">47</span>
                  </div>
                  <div class="flex justify-between items-center">
                    <span class="text-slate-600">Total Attendees</span>
                    <span class="font-bold text-slate-900">2,847</span>
                  </div>
                  <div class="flex justify-between items-center">
                  ...
                  <div class="mt-6">
                    ...
                    <div class="w-full bg-slate-200 rounded-full h-3">
                      <div class="bg-gradient-to-r from-blue-500 to-cyan-400 h-3 rounded-full transition-all duration-1000" style="width: 87%"></div>
                    </div>
                  </div>
                </div>
              </div>
...
const features = computed(() => [
  {
    ...
    description: "Create and manage events with our intuitive planning tools. Set dates, venues, and track progress effortlessly with AI-powered suggestions.",
  ...
  },
  {
    ...
    description: "Manage attendee lists, send personalized invitations, and track RSVPs with automated follow-ups and custom registration forms.",
    bgColor: "bg-gradient-to-br from-blue-100 to-blue-200",
    iconColor: "text-blue-600",
  },
  {
    ...
    description: "Get detailed insights into event performance, attendance rates, and engagement metrics with beautiful interactive dashboards.",
  ...
  },
  {
    ...
    description: "Keep attendees engaged with automated emails, push notifications, announcements, and real-time chat features.",
  ...
  },
  {
    ...
    description: "Seamlessly integrate with venue booking systems, display interactive maps, and provide detailed location information.",
  ...
  },
  {
    icon: Camera,
    title: "Media & Content",
    description: "Upload and share event photos, videos, documents, and create stunning event galleries with automatic organization.",
...
const testimonials = computed(() => [
  {
    ...
    content: "GoEvent transformed how we manage our company conferences. The analytics feature helped us increase attendance by 40%.",
  },
  {
    name: "Michael Chen",
    role: "Wedding Planner",
    content: "The guest management system is incredible. My clients love how easy it is to track RSVPs and communicate with guests.",
  },
  {
...
const faqs = computed(() => [
  {
    ...
    answer: "GoEvent offers flexible pricing plans to suit different needs. We have a free tier for small events, and paid plans starting at $300/event for customize design. Business solutions are available with custom pricing."
  },
  {
    question: "Is my event data secure and private?",
    answer: "Absolutely. We take security seriously with enterprise-grade encryption, SOC 2 compliance, and GDPR compliance. Your data is stored securely with regular backups, and we never share your information with third parties. You maintain full ownership and control of your event data."
  },
  {
    question: "What types of events can I manage with GoEvent?",
    answer: "GoEvent is versatile and supports all types of events including conferences, workshops, webinars, weddings, corporate meetings, trade shows, festivals, and more. Whether it's a 10-person workshop or a 10,000-person conference, our platform scales to meet your needs."
  },
  {
    question: "Do you offer customer support?",
    answer: "Yes! We provide comprehensive support including 24/7 chat support, email support, extensive documentation, video tutorials, and webinar training sessions. Premium plans include dedicated account managers and priority support with guaranteed response times."
  },
  {
    question: "Can I customize the registration forms and event pages?",
    answer: "Definitely! GoEvent offers extensive customization options including custom registration forms, branded event pages, personalized email templates, and white-label solutions. You can match your organization's branding and create a seamless experience for your attendees."
  }
])
