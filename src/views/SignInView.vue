        ...
        <form class="space-y-6" @submit.prevent="handleSignIn">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span class="text-sm font-medium text-slate-700 group-hover:text-slate-900">{{ isGoogleLoading ? 'Signing in...' : 'Google' }}</span>
            </button>
