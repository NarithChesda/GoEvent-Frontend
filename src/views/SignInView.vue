  ...
  >
    ...
    <div class="relative z-10 w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <RouterLink to="/" class="inline-flex items-center justify-center mb-4">
          <img
            :src="LogoSvg"
            alt="GoEvent Logo"
            class="h-24 w-auto max-w-full object-contain sm:h-32"
          />
      ...
      >
        ...
        <div class="relative my-6 sm:my-8">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-white/80 text-slate-500 font-medium">Or use legacy sign in</span>
          </div>
        </div>
        ...
        <div class="border border-slate-200 rounded-xl overflow-hidden">
          ...
          >
            <span class="text-sm font-medium text-slate-700">Legacy Sign In (Email & Password)</span>
            <svg
              :class="['w-5 h-5 text-slate-500 transition-transform', showLegacySignIn ? 'rotate-180' : '']"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
