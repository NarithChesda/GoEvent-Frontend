        ...
        <div class="glass-card rounded-2xl p-6 sm:p-8">
          ...
          <div class="space-y-3">
            ...
            <button
              ...
              class="relative w-full flex items-center justify-center px-4 py-3 border border-sky-300 rounded-xl bg-white hover:bg-sky-50 transition-all duration-200 hover:border-sky-400 focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 disabled:opacity-50 disabled:cursor-not-allowed group shadow-sm hover:shadow-md hover:shadow-sky-500/10"
            >
              <span
                class="absolute -top-2 right-3 inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-gradient-to-r from-sky-500 to-blue-500 text-white text-[10px] font-semibold uppercase tracking-wide shadow-sm ring-2 ring-white"
              >
...
import { Eye, EyeOff, Loader2, AlertCircle, ChevronDown, Send, X, Sparkles } from 'lucide-vue-next'
