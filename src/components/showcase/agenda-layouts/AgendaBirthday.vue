<template>
  ...
  >
    ...
    <div class="birthday-tab-container" :style="{ '--primary-color': primaryColor }">
      ...
      <!-- Tab Content - only the active tab's panel renders; keying on
...
const getTabStyle = (date: string) => {
  ...
  return {
    ...base,
    backgroundColor: `${props.backgroundColor || props.primaryColor}60`,
    color: hasBackground ? props.primaryColor : '#ffffff',
