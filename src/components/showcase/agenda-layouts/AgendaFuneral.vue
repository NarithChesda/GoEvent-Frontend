<template>
  <div
    ...
    ref="containerRef"
    :key="`agenda-funeral-${currentLanguage}`"
  ...
  >
    ...
    <!-- Tab Navigation -->
    <div class="funeral-tab-container" :style="{ '--primary-color': primaryColor }">
      <div
            ...
            >
              <div class="agenda-item-content">
                ...
                <p
                  ...
                  :class="[
                    'text-center text-xs sm:text-sm mb-1 agenda-item-description',
                    currentLanguage === 'kh' && 'khmer-text-fix',
                  ]"
                  :style="{
                    color: primaryColor,
...
const agendaHeaderText = computed(() => getTextContent('agenda_header_birthday', 'Program'))
