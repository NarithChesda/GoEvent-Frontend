<template>
  <div class="host-info-wrapper" :class="{ 'khmer-text': currentLanguage === 'kh' }">
    <!-- Grid container with 5 rows (removed parent name rows) -->
    <div class="host-info-grid">
      ...
      <!-- Row 5: Host Profile Pictures (only show if both hosts have profile images) -->
      <div
...
@media (min-width: 1024px) and (max-width: 1365px) {
  ...
  .parent-name-text {
    font-size: 0.55rem; /* Reduced from 0.7906rem to 0.55rem (8.8px) */
  }

  .host-name-text {
    font-size: 0.7rem; /* Reduced from 0.85rem to 0.7rem (11.2px) */
  }
