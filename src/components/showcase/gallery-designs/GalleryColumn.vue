<template>
  <!-- One photograph after another at the card's width, uncropped. The
       gallery as it has always been, moved here unchanged when the section
       gained designs; `column` is the default and every template that never
       chose one renders it. -->
  <div ref="gridRef" class="photo-grid" :style="{ '--photo-mat': photoMatColor }">
    <div
...
/**
 * The photo's `img` element, if it is in the document.
 *
