...
@media (min-width: 1024px) and (max-width: 1365px) {
  ...
  /* Sign In Button */
  .rsvp-btn-signin {
    padding: 0.46875rem 0.9375rem; /* 0.625rem * 0.75, 1.25rem * 0.75 */
    font-size: 0.65625rem; /* ~10.5px - 0.875rem * 0.75 */
    border-radius: 1.125rem; /* 1.5rem * 0.75 */
  }

  .signin-icon {
    width: 0.84375rem; /* 1.125rem * 0.75 */
    height: 0.84375rem;
  }
  ...
  .toggle-switch {
    width: 2.0625rem; /* 2.75rem * 0.75 */
    height: 1.125rem; /* 1.5rem * 0.75 */
    border-radius: 0.5625rem; /* 0.75rem * 0.75 */
  }

  .toggle-thumb {
    top: 0.1875rem; /* 0.25rem * 0.75 */
    left: 0.1875rem;
    width: 0.75rem; /* 1rem * 0.75 */
    height: 0.75rem;
  }
  ...
  .toggle-switch.active .toggle-thumb {
    transform: translateX(0.9375rem) !important; /* 1.25rem * 0.75 */
  }
  ...
  .stepper-label {
    font-size: 0.609375rem; /* ~9.75px - 0.8125rem * 0.75 */
  }
  ...
  .stepper-btn {
    width: 1.3125rem; /* 1.75rem * 0.75 */
    height: 1.3125rem;
    border-width: 1.125px; /* 1.5px * 0.75 */
  }
  ...
  .stepper-value {
    font-size: 0.84375rem; /* ~13.5px - 1.125rem * 0.75 */
    min-width: 1.5rem; /* 2rem * 0.75 */
  }

  /* Confirmation Chip */
  .confirmation-chip {
    padding: 0.375rem 0.75rem; /* 0.5rem * 0.75, 1rem * 0.75 */
    border-radius: 0.75rem; /* 1rem * 0.75 */
    border-width: 1.125px; /* 1.5px * 0.75 */
  }

  .confirmation-text {
    font-size: 0.5625rem; /* ~9px - 0.75rem * 0.75 */
  }
  ...
  /* Loading Spinner */
  .spinner-white {
    width: 0.9375rem; /* 1.25rem * 0.75 */
    height: 0.9375rem;
    border-width: 1.5px; /* 2px * 0.75 */
  }
}

/* Medium laptops 14-15 inch (1366px-1535px) - Scale to 75% to match HostInfo */
...
@media (min-width: 1920px) {
  /* Use default sizes - no scaling needed */
}
</style>
