<template>
  <div v-if="showModal" class="fixed inset-0 bg-black/50 modal-backdrop flex items-center justify-center z-[60] p-2 sm:p-4">
    <div class="bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-4xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
      <!-- Modal Header -->
          ...
          <div v-if="template.preview_image" class="relative rounded-2xl overflow-hidden">
            ...
            <div class="absolute bottom-4 left-4 right-4">
              <div class="flex items-center space-x-3">
                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-white/20 backdrop-blur-sm text-white">
          ...
          <div v-if="hasAssets">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div v-if="template.basic_background_photo" class="group">
                <div class="bg-slate-50 rounded-lg border border-slate-200 overflow-hidden hover:shadow-md transition-all">
      ...
      <div class="flex items-center justify-between p-4 sm:p-6 border-t bg-slate-50">
        <div class="flex items-center space-x-2 text-sm text-slate-600">
          <span>Price:</span>
          <span class="font-bold text-lg text-green-600">${{ template.package_plan?.price || '0.00' }}</span>
        </div>
        ...
        <div class="flex space-x-3">
          ...
          <button
            ...
            class="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-2 px-6 rounded-xl transition-all duration-200 hover:scale-[1.02] shadow-lg shadow-blue-500/25 hover:shadow-blue-600/30 flex items-center"
          >
...
const hasAssets = computed(() => {
  return props.template.basic_background_photo || 
