        ...
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-100">
              <div>
                <h3 class="text-xl font-bold text-slate-900">Edit Agenda Item</h3>
                <p class="text-sm text-slate-600 mt-1">Update your event schedule item</p>
              </div>
              <button
                @click="$emit('close')"
            ...
            <!-- Form -->
            <form @submit.prevent="updateAgendaItem" class="overflow-y-auto max-h-[calc(90vh-120px)]">
                    ...
                    >
                      ...
                      <div class="space-y-3 pr-8">
                        <div class="flex items-center justify-between">
                          ...
                          <span v-if="translation.id" class="text-xs text-green-600 bg-green-100 px-2 py-1 rounded-full">
                            Saved
                          </span>
                        </div>
...
import { agendaService, coreDataService, type EventAgendaItem, type AgendaTranslation, type AgendaIcon } from '../services/api'
...
// Computed
const availableLanguagesForAdd = ref(availableLanguages.filter(lang => 
...
const addTranslation = () => {
  ...
  availableLanguagesForAdd.value = availableLanguages.filter(lang => 
    !formData.translations.some(t => t.language === lang.code)
  )
...
const updateAgendaItem = async () => {
  ...
  try {
    ...
    const validTranslations = cleanedTranslations.filter(t => 
