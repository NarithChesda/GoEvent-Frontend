      ...
      >
        ...
        <div class="flex-1 overflow-y-auto overscroll-contain">
          ...
          <form @submit.prevent="handleSubmit" class="p-4 space-y-5 pb-24">
            ...
            <div class="space-y-2">
              <h3 class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Profile Picture</h3>
            ...
            <div class="space-y-2 border-t border-slate-100 pt-5">
              <h3 class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Language Content</h3>
              <LanguageTabs
