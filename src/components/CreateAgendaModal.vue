                    ...
                    <div>
                      ...
                      <div class="flex items-center space-x-3">
                        ...
                        <input
                          v-model="formData.color"
                          type="text"
                          class="flex-1 px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#1e90ff] focus:border-[#1e90ff] transition-all duration-200 bg-white/70 backdrop-blur-sm"
                          placeholder="#3498db"
                        />
                      </div>
                    </div>
