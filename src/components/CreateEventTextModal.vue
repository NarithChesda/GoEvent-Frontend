      ...
      <div v-if="true" class="fixed inset-0 z-50 overflow-y-auto" @click="$emit('close')">
        ...
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <div class="bg-gradient-to-r from-[#2ecc71] to-[#1e90ff] px-4 sm:px-8 py-4 sm:py-6 text-white">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <div>
                    <h2 class="text-lg sm:text-2xl font-bold">Add Text Content</h2>
                    <p class="text-xs sm:text-sm text-[#B0E0E6] mt-0.5 sm:mt-1">Create new text content for your event</p>
                  </div>
                </div>
                <button
                  @click="$emit('close')"
            ...
            <!-- Form -->
            <form @submit.prevent="createText" class="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5 md:space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
              <div class="space-y-4 sm:space-y-5 md:space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div class="flex items-center pt-6 sm:pt-8">
                    ...
                    />
                    <label for="is_active" class="ml-2 text-xs sm:text-sm font-medium text-slate-700">
...
import { X, Info, FileText, Loader } from 'lucide-vue-next'
